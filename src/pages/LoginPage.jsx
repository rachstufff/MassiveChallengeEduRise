            ...
            <div className="flex items-center">
              ...
              <div className="hidden lg:flex ml-8">
                <ul className="flex space-x-6">
                  ...
                  <li>
                    <Link className="font-bold text-[#3375CC] !text-[#3375CC] !underline underline" to="/login">LOGIN PAGE</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="w-full max-w-[1130px] h-[720px] bg-white rounded-lg overflow-hidden shadow-md mx-auto">
            <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="w-full max-w-[400px]">
                  <div className="text-center mb-[85px]">
                    <h2 className="text-2xl font-bold">
                      ...
                      <span className="text-[#3375cc] italic">EDU</span><span
                        className="text-[#dda853] italic">RISE</span>
                    </h2>
                  ...
                  <form>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="flex">
                        <input
                          ...
                          defaultValue="**********"
                        />
                        {/* <span className="bg-gray-100 border border-gray-300 border-l-0 px-2 flex items-center">
                                                    <img src="/img/li_lock.png" alt="Lock Icon" width="24" height="24" />
                                                </span> */}
                        <button
                          type="button"
                    ...
                    {/* INI DIHUBUGKAN KE landingAfter.jsx */}
                    <div className="mt-4">
                      <Link to="/landingpage">
                        <button
                          type="button"
                    ...
                    <p className="text-center mt-4">
                      Don't have an account? <Link to="/registerpage" className="!text-[#DDA853] font-medium hover:underline">Sign up here!</Link>
                    </p>
                  </form>
                </div>
              </div>
              ...
              <div className="hidden md:block md:w-1/2 h-full overflow-hidden">
                <img src="/img/eduriselanding/Rectangle 2.png" alt="Login Image" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </section>
