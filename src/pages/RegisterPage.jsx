        ...
        <section className="flex justify-center items-center min-h-[calc(100vh-76px)] px-5 mt-20 mb-20">
          <div className="w-full max-w-[1130px] h-[720px] bg-white rounded-lg overflow-hidden shadow-md mx-auto">
            <div className="flex flex-col md:flex-row h-full">
              ...
              <div className="w-full md:w-1/2 flex items-start justify-center p-10 pt-16">
                <div className="w-full max-w-[400px]">
                  <div className="text-center mb-[60px]">
                    ...
                    <p className="text-gray-500 mb-6">Lengkapi Data Akun dan mendaftar Untuk Melanjutkan</p>
                  </div>

                  <form className="mt-0">
                    <div className="mb-4">
                      <label htmlFor="email" className="block font-bold mt-3 mb-1">Email</label>
                      <div className="flex">
                        <input
                          type="email"
                    ...
                    <div className="mb-3">
                      ...
                      <div className="flex justify-end mt-2">
                        <Link to="/resetpage" className="text-sm text-[#3375CC] hover:underline">Forgot Password?</Link>
                      </div>
                    </div>
                    ...
                    <p className="text-center mt-4">
                      Already have an account? <Link to="/login" className="!text-[#DDA853] !hover:underline">Sign in here!</Link>
                    </p>
                  </form>
                </div>
              </div>
              ...
              {/* Image Section */}
              <div className="hidden md:block w-1/2 bg-cover bg-center" style={{ backgroundImage: "url('/img/eduriselanding/3d-render-books-fly-fall-blue-background.jpg')" }}>
              </div>
            </div>
          </div>
        </section>
