        ...
        <div className="flex flex-col pl-5 gap-4 w-[80%] border-l-[3px] border-gray-200 h-full">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="w-full p-8 bg-white flex flex-col rounded-xl shadow-sm">
              <h1 className="text-2xl font-semibold mb-3">Persiapan Magang di Startup Digital</h1>
              ...
              <p className="w-full text-base text-gray-500 mt-3 break-words whitespace-pre-line">
                Pelajari cara membangun CV, melamar ke startup, dan mempersiapkan interview bersama mentor yang sudah magang di unicorn.
              </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-lg">
            ...
            <p className="text-center text-gray-600 mb-4">
              ...
              <strong>Bangun Portofolio UI/UX dari Nol</strong>?
            </p>
