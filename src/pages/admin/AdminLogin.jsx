...
import "../stylepages.css"; // Assuming you have a CSS file for styles
        ...
        <nav className="navbar navbar-expand-lg bg-white fixed-top navbar-shadow">
          <div className="container navbar-container">
            ...
            <div className="profile-button-container">
              <a href="loginadmin.html" className="profile-button">
                <svg
          ...
          <div className="login-container">
            <div className="row g-0 h-100">
              ...
              <div className="col-md-6 login-image-section">
                <img
                  src="/img/eduriselanding/3d-render-student-graduation-education-school.jpg"
                  alt="Login Image"
