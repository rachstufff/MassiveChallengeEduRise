            ...
            <div className="flex items-center">
              ...
              <div className="hidden lg:flex ml-8">
                <ul className="flex space-x-6">
                  ...
                  <li>
                    <Link className="font-bold text-[#3375CC] underline !text-[#3375CC] !underline" to="/login">LOGIN PAGE</Link>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="flex justify-center items-center min-h-[calc(100vh-76px)] px-5 mt-20 mb-20">
          <div className="w-full max-w-[1130px] h-[720px] bg-white rounded-lg overflow-hidden shadow-md mx-auto">
            <div className="flex flex-col md:flex-row h-full">
              ...
              <div className="w-full md:w-1/2 flex items-start justify-center p-10 pt-16">
                <div className="w-full max-w-[400px]">
                  <div className="text-center mb-[50px]">
                    ...
                    <p className="text-gray-500 mb-6">Lupa Password? Jangan Khawatir! Lengkapi Data Akun Anda Untuk Meresetnya</p>
                  </div>

                  <form className="mt-0">
                    <div className="mb-4">
                      <label htmlFor="username" className="block font-bold mt-3 mb-1">Username</label>
                      <div className="flex">
                        <input
                          type="text"
                        ...
                        <span className="inline-flex items-center px-3 bg-gray-100 border border-l-0 border-gray-300 rounded-r">
                          <img src="/img/eduriselanding/li_user.png" alt="User Icon" className="w-6 h-6" />
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      <label htmlFor="password" className="block font-bold mb-1">New Password</label>
                      <div className="flex">
                        <input
                          type="password"
                          className="w-full px-3 py-2 border border-gray-300 rounded-l focus:outline-none focus:ring-2 focus:ring-[#3375CC]/25 focus:border-[#3375CC]"
                        ...
                        />
                        <span className="inline-flex items-center px-3 bg-gray-100 border border-l-0 border-gray-300 rounded-r">
                          <img src="/img/eduriselanding/li_lock.png" alt="Lock Icon" className="w-6 h-6" />
                        </span>
                      </div>
                    </div>

                    <div className="mt-6">
                      <button type="submit" className="w-full bg-[#3375CC] hover:bg-[#295ea3] text-white font-bold py-2 px-4 rounded transition-colors">
                        Reset
                      </button>
                    </div>

                    <p className="text-center mt-4">
                      Don't have an account? <Link to="/registerpage" className="!text-[#DDA853] hover:underline">Sign up here!</Link>
                    </p>
                  </form>
                </div>
              </div>
              ...
              {/* Image Section */}
              <div className="hidden md:block w-1/2 bg-cover bg-center" style={{ backgroundImage: "url('/img/eduriselanding/stack-books-lightbulb-3d-render-icon.jpg')" }}>
              </div>
            </div>
          </div>
        </section>
